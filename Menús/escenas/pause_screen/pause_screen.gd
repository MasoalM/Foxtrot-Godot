...
@onready var score = $"Control/Fondo/Menú de pausa/InfoCargar/Puntuación"
@onready var level_completed = $"Control/Fondo/Menú de pausa/InfoCargar/Niveles completados"
